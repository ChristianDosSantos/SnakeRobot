...
subplot(3, 2, 1)
plot(ie, IENG);
title('Función de membresía para IENG');
ylabel('Grado de Pertenencia');
xlabel('Integral del Error')
subplot(3, 2, 2)
plot(ie, IENP);
title('Función de membresía para IENP');
ylabel('Grado de Pertenencia');
xlabel('Integral del Error')
subplot(3, 2, 3)
plot(ie, IEC);
title('Función de membresía para IEC');
ylabel('Grado de Pertenencia');
xlabel('Integral del Error')
subplot(3, 2, 4)
plot(ie, IEPP);
title('Función de membresía para IEPP');
ylabel('Grado de Pertenencia');
xlabel('Integral del Error')
subplot(3, 2, 5)
plot(ie, IEPG);
title('Función de membresía para IEPG');
ylabel('Grado de Pertenencia');
xlabel('Integral del Error');
figure()
subplot(3,1,1)
